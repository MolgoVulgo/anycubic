...
- Onglets MQTT / Print / LOG: utilitaires (pas de spec UI).
...
- Pas de spec pour MQTT / Print / LOG.
...
- accloud/ui/views/mqtt_tab.py / print_tab.py / log_tab.py: placeholders propres.
...
- Etape 4: placeholders MQTT/Print/LOG.
